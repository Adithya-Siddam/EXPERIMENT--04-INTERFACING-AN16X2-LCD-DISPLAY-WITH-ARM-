...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  Lcd_cursor(&lcd, 0,1);
	  Lcd_string(&lcd, "Adithya\n");
	  HAL_Delay(100);
	  Lcd_cursor(&lcd, 1,0);
	  for(int x=0;x<1;x++)
	  {
		  Lcd_string(1,0);
		  Lcd_string(&lcd, "212221230100");
	   HAL_Delay (200);
...
## Output screen shots of proteus  :
 ![image](https://github.com/Adithya-Siddam/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/93427248/e8d070e0-4886-4bc7-8b72-bff88a9726ee)

 
![image](https://github.com/Adithya-Siddam/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/93427248/15da0a5b-96c2-40b3-bd2a-55c727621b21)
